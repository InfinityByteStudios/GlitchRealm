...
return true;
     ...
     * @private
     * @returns {Promise<number|boolean>} - Minutes saved or false on failure
     */
    async _savePlaytime() {
...
// Get current data
            ...
            console.error(`[PlaytimeTracker] ❌ Error saving playtime:`, error);
            return false;
        }
    }
     ...
     * This is a convenience method that calls the private _savePlaytime method
     * @returns {Promise<boolean|number>} - Success status or minutes saved
     */
    async savePlaytimeData() {
        // Update the playtime before saving
        this._updatePlaytime();
        // Save the data
        return this._savePlaytime();
    }
